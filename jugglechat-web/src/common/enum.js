...
let ASIDE_MENU_TYPE = {
  ...
  USER_PRIVACY: 14,
  ABOUT: 15,
  ADMIN_MULTI_ACCOUNT: 100,
  ADMIN_IP_MONITOR: 101,
  ADMIN_IP_CHANGES: 102,
};
...
let SETTING_CARDS = [
  ...
  { tag: 4, 
    menus: [ 
    { name: '关于乐享', icon: 'about', event: ASIDE_MENU_TYPE.ABOUT },
    ] 
  },
  { tag: 5, 
    isVip: true,
    ...
    { name: 'IP变动通知', icon: 'fav', event: ASIDE_MENU_TYPE.ADMIN_IP_CHANGES },
    ] 
  },
  { tag: 10, 
    menus: [ 
...
export { STORAGE, USER_AGREEMENT, SETTING_CARDS, ASIDE_MENU_TYPE, LANGUAGES, GROUP_ROLE, ASIDER_SETTING_SWITCH, GROUP_AVATAR, FILE_TYPE, SYS_CONVERSATION_FRIEND, SYS_CONVERSATION_GROUP, IGNORE_CONVERSATIONS, FRIEND_APPLY_STATUS, CONTACT_TYPE, SETTING_TYPE, EMOJI_POS_LIST, EVENT_NAME, TRANSFER_TYPE, CONTACT_TAB_TYPE, RESPONSE, GROUP_CHANGE_TYPE, MSG_NAME, REG_EXP, MESSAGE_OP_TYPE, CONVERATION_TAG_ID, CONVERSATION_TAG_TYPE, MsgStatus }