      ...
      <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0 modal-merge-content">
              ...
              <div v-for="message in state.messages">
                <div class="tny-conent-msg">
                  <div class="tyn-reply-item ingoing">
                    ...
                    <ImageMessage v-else-if="utils.isEqual(message.name, MessageType.IMAGE)" :message="message" :is-read=1></ImageMessage>
          ...
          <button @click="onCancel()"
            class="btn btn-md btn-icon btn-pill btn-white shadow position-absolute top-0 end-0 mt-n3 me-n3 wr jg-icon-close"></button>
        </div>
      </div>
    </DialogContent>
