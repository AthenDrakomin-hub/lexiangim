...
CREATE TABLE IF NOT EXISTS `accounts` (
  ...
  `account` varchar(45) DEFAULT NULL COMMENT '登录�?,
  ...
  `state` tinyint DEFAULT '0' COMMENT '状�?,
  `role_type` tinyint DEFAULT 0 COMMENT '角色类型',
    `app_key` varchar(45) DEFAULT NULL COMMENT '绑定的应用key（仅应用管理员需要）',
  `parent_account` varchar(45) DEFAULT NULL COMMENT '父账�?,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uniq_account` (`account`),
  KEY `idx_parent` (`parent_account`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT = '管理�?账号';
...
CREATE TABLE IF NOT EXISTS `androidpushconfs` (
  ...
  `push_channel` varchar(10) DEFAULT NULL COMMENT '推送渠�?,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT = 'android推送配�?;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT = '应用访问地址与别�?;

CREATE TABLE IF NOT EXISTS `apps` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `app_key` varchar(45) NOT NULL COMMENT '应用key',
  `app_secret` varchar(45) NOT NULL COMMENT '应用密钥 16�?,
  `app_secure_key` varchar(45) NOT NULL COMMENT '安全key 16�?,
  `app_status` tinyint DEFAULT '0' COMMENT '状�?,
  `created_time` datetime(3) DEFAULT CURRENT_TIMESTAMP(3) COMMENT '创建时间',
  `updated_time` datetime(3) DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3) COMMENT '更新时间',
...
CREATE TABLE IF NOT EXISTS `banusers` (
  ...
  `user_id` varchar(32) NOT NULL COMMENT '用户id',
    `vip_level` tinyint NOT NULL DEFAULT 0 COMMENT 'VIP等级：0=普通用户，1=VIP用户',
  `created_time` datetime(3) DEFAULT CURRENT_TIMESTAMP(3) COMMENT '创建时间',
  `end_time` bigint DEFAULT '0' COMMENT '结束时间 �? 为永久封�?,
...
CREATE TABLE IF NOT EXISTS `bc_hismsgs` (
  ...
  `channel_type` tinyint DEFAULT NULL COMMENT '会话类型 1单聊, 2群聊�?聊天室，4系统�?群公告，6广播',
  `msg_type` varchar(50) DEFAULT NULL COMMENT '消息类型',
  `msg_id` varchar(20) NOT NULL COMMENT '消息id',
  `send_time` bigint DEFAULT NULL COMMENT '发送时�?,
  `msg_seq_no` int DEFAULT NULL COMMENT '消息seq',
  `msg_body` mediumblob COMMENT '消息�?,
  `app_key` varchar(20) NOT NULL COMMENT '应用key',
  PRIMARY KEY (`id`),
  KEY `idx_msgid` (`app_key`,`conver_id`,`msg_id`,`send_time`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT = '广播-历史消息�?;

CREATE TABLE IF NOT EXISTS `blocks` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `user_id` varchar(32) DEFAULT NULL COMMENT '操作�?,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT = '广播-收件�?;

CREATE TABLE IF NOT EXISTS `chatroominfos` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `chat_id` varchar(32) DEFAULT NULL COMMENT '聊天室id',
  `chat_name` varchar(45) DEFAULT NULL COMMENT '聊天室名�?,
  `created_time` datetime(3) DEFAULT CURRENT_TIMESTAMP(3) COMMENT '创建时间',
  `app_key` varchar(20) DEFAULT NULL COMMENT '应用key',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uniq_chatid` (`app_key`,`chat_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT = '聊天室信�?;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT = 'cmd收件�?;
...
CREATE TABLE IF NOT EXISTS `cmdsendboxmsgs` (
  ...
  KEY `idx_msg_id` (`app_key`,`user_id`,`msg_id`),
  KEY `idx_appkey` (`app_key`,`send_time`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT = 'cmd发件�?;

CREATE TABLE IF NOT EXISTS `convercleantimes` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `conver_id` varchar(100) DEFAULT NULL COMMENT '会话id',
  `sub_channel` varchar(32) DEFAULT '',
  `channel_type` tinyint DEFAULT '0' COMMENT '会话类型 1单聊, 2群聊�?聊天室，4系统�?群公告，6广播',
...
CREATE TABLE IF NOT EXISTS `conversations` (
  ...
  `latest_read_msg_time` bigint DEFAULT '0' COMMENT '最新已读时�?,
  `sort_time` bigint DEFAULT '0' COMMENT 'sort time',
  `is_deleted` tinyint DEFAULT '0' COMMENT '是否删除 0 未删除，1已删�?,
...
CREATE TABLE IF NOT EXISTS `convertagrels` (
  ...
  `channel_type` TINYINT NULL COMMENT '会话类型 1单聊, 2群聊�?聊天室，4系统�?群公告，6广播',
  `sub_channel` varchar(32) DEFAULT '',
  `created_time` DATETIME(3) NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT '创建时间',
  `app_key` VARCHAR(20) NULL COMMENT '应用key',
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT = '会话-分组绑定关系�?;

CREATE TABLE IF NOT EXISTS `msgstats` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `stat_type` TINYINT NULL DEFAULT 0 COMMENT '统计类型 1上行消息�?分发�?下行消息',
  `channel_type` TINYINT NULL COMMENT '会话类型 1单聊, 2群聊�?聊天室，4系统�?群公告，6广播',
...
CREATE TABLE IF NOT EXISTS `msgrealtimestats` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `stat_type` tinyint DEFAULT '0' COMMENT '统计类型 1上行消息�?分发�?下行消息',
  `channel_type` tinyint DEFAULT '0' COMMENT '会话类型 1单聊, 2群聊�?聊天室，4系统�?群公告，6广播',
  `time_mark` bigint DEFAULT '0' COMMENT '30秒时间标�?,
...
CREATE TABLE IF NOT EXISTS `useractivities` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `user_id` VARCHAR(32) NULL COMMENT '用户id',
  `time_mark` BIGINT NULL COMMENT '标记�?,
  `created_time` DATETIME(3) NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT '创建时间',
  `count` INT NULL COMMENT '数量',
  `app_key` VARCHAR(20) NULL COMMENT '应用key',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `fileconfs` (
  ...
  `channel` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'oss供应�?,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT = '群聊-历史消息已删记录�?;
...
CREATE TABLE IF NOT EXISTS `g_hismsgs` (
  ...
  `msg_body` mediumblob COMMENT '消息�?,
  `app_key` varchar(20) DEFAULT NULL COMMENT '应用key',
  `member_count` int DEFAULT '0' COMMENT '成员�?,
  `read_count` int DEFAULT '0' COMMENT '已读�?,
  `is_delete` tinyint DEFAULT '0' COMMENT '是否删除 0未删除， 1已删�?,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT = '群聊-历史消息�?;
...
CREATE TABLE `g_portionrels` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uniq_msgid` (`app_key`, `conver_id`, `sub_channel`, `user_id`, `msg_id`),
  KEY `idx_msg_time` (`app_key`, `conver_id`, `sub_channel`, `user_id`, `msg_time`),
  KEY `idx_appkey_time` (`app_key`,`msg_time`)
)ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT = '群聊-公告消息�?;
...
CREATE TABLE IF NOT EXISTS `globalconfs` (
  ...
  `created_at` datetime(3) DEFAULT CURRENT_TIMESTAMP(3) COMMENT '创建�?,
  `updated_at` datetime(3) DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3) COMMENT '更新�?,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `globalconvers` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `conver_id` varchar(100) DEFAULT NULL COMMENT '会话id',
  `sender_id` varchar(32) DEFAULT NULL COMMENT '发送�?,
  `target_id` varchar(32) DEFAULT NULL COMMENT '接收�?,
  `channel_type` tinyint DEFAULT NULL COMMENT '会话类型 1单聊, 2群聊�?聊天室，4系统�?群公告，6广播',
  `sub_channel` varchar(32) DEFAULT '',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT = '全局会话�?;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT = '群补充信�?;

CREATE TABLE IF NOT EXISTS `groupinfos` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `group_id` varchar(64) DEFAULT NULL COMMENT '群id',
  `group_name` varchar(64) DEFAULT NULL COMMENT '群名�?,
  `group_portrait` varchar(200) DEFAULT NULL COMMENT '群头�?,
  `created_time` datetime(3) DEFAULT CURRENT_TIMESTAMP(3) COMMENT '创建时间',
  `app_key` varchar(20) DEFAULT NULL COMMENT '应用key',
  `is_mute` tinyint DEFAULT '0' COMMENT '是否全局禁言�?：否�?：是�?,
  `updated_time` datetime(3) DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3) COMMENT '更新时间',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uniq_appkey_groupid` (`app_key`,`group_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT = '群基本信�?;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT = '群成�?补充信息';
...
CREATE TABLE IF NOT EXISTS `groupmembers` (
  ...
  `is_mute` tinyint DEFAULT '0' COMMENT '是否全局禁言�?：否�?：是�?,
  `is_allow` tinyint DEFAULT '0' COMMENT '是否白名�?0:非白名单用户�?:白名单用户；',
  `mute_end_at` bigint DEFAULT '0' COMMENT '禁言结束时间�?,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT = '群成�?;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT = '群快�?;

CREATE TABLE IF NOT EXISTS `ic_conditions` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `channel_type` varchar(100) DEFAULT NULL COMMENT '会话类型 1单聊, 2群聊�?聊天室，4系统�?群公告，6广播',
...
CREATE TABLE IF NOT EXISTS `inboxmsgs` (
  ...
  KEY `idx_msg_id` (`app_key`,`user_id`,`msg_id`),
  KEY `idx_appkey` (`app_key`,`send_time`)
) ENGINE=InnoDB AUTO_INCREMENT=45612 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT = '收件�?;
...
CREATE TABLE IF NOT EXISTS `mergedmsgs` (
  ...
  `from_id` varchar(32) DEFAULT NULL COMMENT '发送�?,
  `target_id` varchar(32) DEFAULT NULL COMMENT '接收�?,
  `channel_type` tinyint DEFAULT NULL COMMENT '会话类型 1单聊, 2群聊�?聊天室，4系统�?群公告，6广播',
  `sub_channel` varchar(32) DEFAULT '',
  `msg_id` varchar(20) DEFAULT NULL COMMENT '消息id',
...
CREATE TABLE IF NOT EXISTS `p_delhismsgs` (
  ...
  KEY `idx_target` (`app_key`,`user_id`,`target_id`,`sub_channel`,`msg_time`),
  KEY `idx_appkey_time` (`app_key`,`msg_time`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT = '单聊-历史消息已删记录�?;
...
CREATE TABLE IF NOT EXISTS `p_hismsgs` (
  ...
  `sub_channel` varchar(32) DEFAULT '',
  `sender_id` varchar(32) DEFAULT NULL COMMENT '发送�?,
  `receiver_id` varchar(32) DEFAULT NULL COMMENT '接收�?,
  `channel_type` tinyint DEFAULT NULL COMMENT '会话类型 1单聊, 2群聊�?聊天室，4系统�?群公告，6广播',
  `msg_type` varchar(50) DEFAULT NULL COMMENT '消息类型',
  `msg_id` varchar(20) DEFAULT NULL COMMENT '消息id',
  `send_time` bigint DEFAULT NULL COMMENT '发送时�?,
  ...
  `msg_body` mediumblob COMMENT '消息�?,
  `app_key` varchar(20) DEFAULT NULL COMMENT '应用key',
  `is_read` tinyint DEFAULT '0' COMMENT '是否已读 0未读�?已读',
...
CREATE TABLE IF NOT EXISTS `sendboxmsgs` (
  ...
  KEY `idx_msg_id` (`app_key`,`user_id`,`msg_id`),
  KEY `idx_appkey` (`app_key`,`send_time`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT = '发件�?;
...
CREATE TABLE IF NOT EXISTS `sensitivewords` (
  ...
  `word` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '敏感�?,
  `word_type` tinyint(1) NOT NULL DEFAULT '1' COMMENT '敏感词过滤类型�?：拦截敏感词�?：替换敏感词�?,
  `created_time` datetime(3) DEFAULT CURRENT_TIMESTAMP(3) COMMENT '创建时间',
  `updated_time` datetime(3) DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3) COMMENT '更新时间',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uniq_word` (`app_key`,`word`),
  KEY `idx_appkey` (`app_key`,`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT = '敏感�?;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT = '用户-补充信息�?;

CREATE TABLE IF NOT EXISTS `users` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `user_type` tinyint DEFAULT '0' COMMENT '用户类型 0用户, 1机器�?,
  `user_id` varchar(32) NOT NULL COMMENT '用户id',
    `vip_level` tinyint NOT NULL DEFAULT 0 COMMENT 'VIP等级：0=普通用户，1=VIP用户',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT = '用户-基本信息�?;
...
CREATE TABLE IF NOT EXISTS `clientlogs` (
  ...
  `user_id` VARCHAR(32) NULL COMMENT '用户id',
  `created_time` DATETIME(3) NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT '创建时间',
  `start` BIGINT NULL COMMENT '开始时�?,
  `end` BIGINT NULL COMMENT '结束时间',
  `log` MEDIUMBLOB NULL COMMENT '详情',
  `state` TINYINT NULL DEFAULT 0 COMMENT '状�?,
  `platform` VARCHAR(20) NULL COMMENT '客户端类�?ios, android, web',
...
CREATE TABLE IF NOT EXISTS `rtcrooms` (
  ...
  `owner_id` varchar(32) DEFAULT NULL COMMENT '创建�?,
  `ext` varchar(2000) DEFAULT NULL COMMENT '扩展字段',
  `created_time` datetime(3) DEFAULT CURRENT_TIMESTAMP(3) COMMENT '创建时间',
  `accepted_time` bigint DEFAULT '0' COMMENT '1v1 接通时�?,
  `conver_id` VARCHAR(100) NULL,
  `channel_type` TINYINT NULL DEFAULT 0,
  `sub_channel` VARCHAR(32) NULL DEFAULT '',
  `app_key` varchar(20) DEFAULT NULL COMMENT '应用key',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT = 'rtc-房间�?;
...
CREATE TABLE IF NOT EXISTS `rtcmembers` (
  ...
  `rtc_state` tinyint DEFAULT '0'  COMMENT '状�?,
  ...
  `connect_time` bigint DEFAULT '0' COMMENT '通话开始时�?,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT = 'rtc-成员�?;
...
CREATE TABLE IF NOT EXISTS `friendrels` (
  ...
  `display_name` varchar(50) DEFAULT '' COMMENT '好友备注�?,
  `order_tag` varchar(20) NULL DEFAULT '' COMMENT '好友的排序标�?,
  `created_time` datetime(3) DEFAULT CURRENT_TIMESTAMP(3) COMMENT '创建时间',
  `updated_time` datetime(3) DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3) COMMENT '更新时间',
  `app_key` varchar(20) DEFAULT NULL COMMENT '租户key',
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT '好友绑定关系�?;
...
CREATE TABLE IF NOT EXISTS `performance_metrics` (
  ...
  `metric_value` double NOT NULL DEFAULT 0 COMMENT '指标�?,
  `created_time` datetime(3) DEFAULT CURRENT_TIMESTAMP(3) COMMENT '创建时间',
  PRIMARY KEY (`id`),
