...
var (
	...
	//invite code
	IMErrorCode_INVITE_CODE_INVALID   IMErrorCode = 17501
	IMErrorCode_INVITE_CODE_EXPIRED   IMErrorCode = 17502
	IMErrorCode_INVITE_CODE_USED_UP   IMErrorCode = 17503

	//db operation
	IMErrorCode_DB_OperationFailed    IMErrorCode = 17600
