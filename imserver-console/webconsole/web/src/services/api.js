...
let SERVER_PATH = {
  ...
  INVITECODE_CREATE: 'apps/invitecodes/create',
  INVITECODE_LIST: 'apps/invitecodes/list',
  INVITECODE_DELETE: 'apps/invitecodes/delete',
  INVITECODE_STATUS: 'apps/invitecodes/status',
