...
func Route(eng *gin.Engine, prefix string) *gin.RouterGroup {
	...
	group.POST("/accounts/updaterole", apis.UpdateRole)
	...
	group.POST("/apps/users/updateprofile", apis.UpdateUserProfile)
	group.POST("/apps/users/delete", apis.DeleteUser)
	group.POST("/apps/users/resetpassword", apis.ResetUserPassword)
	...
	//invite codes
	group.POST("/apps/invitecodes/create", apis.CreateInviteCode)
	group.GET("/apps/invitecodes/list", apis.ListInviteCodes)
	group.POST("/apps/invitecodes/delete", apis.DeleteInviteCode)
	group.POST("/apps/invitecodes/status", apis.UpdateInviteCodeStatus)
